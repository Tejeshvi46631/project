...
class BillDetails extends StatelessWidget {
  ...
  const BillDetails({super.key, required this.order, required this.shopByReaginProduct, required this.listSimilarProductListItem});
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      getCurrencyFormatdouble(order.finalTotal),
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        color: ColorsRes.appColor,
                      ),
