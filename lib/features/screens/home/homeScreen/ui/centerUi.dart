...
class HomeCenterUI extends StatefulWidget {
  ...
  HomeCenterUI({Key? key, required this.scrollController, this.map}) : super(key: key);
  @override
              ...
              return homeScreenProvider.homeScreenState == HomeScreenState.loaded
                ...
                children: [
                  ...
                  if (homeScreenProvider.map.containsKey("below_slider"))
                    getOfferImages(homeScreenProvider.map["below_slider"]!.toList()),
                  Align(
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      Category category = homeScreenProvider.homeScreenData.category
                          .where((element) => element.hasChild == true)
                          .toList()[index];
                      return InkWell(
                        onTap: () {
                  ...
                  if (homeScreenProvider.homeScreenData.topBanners.length > 0)
                    ListView.builder(
                      itemCount: homeScreenProvider.homeScreenData.topBanners.length - 1,
                      physics: NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemBuilder: (context, index) => BannerUi(
                        banner: homeScreenProvider.homeScreenData.topBanners[index + 1],
                      ),
                    ),
                  HomeScreenCategory.categoryWidget(
                    ...
                    mixWithSliderBanners: homeScreenProvider.homeScreenData.mixWithSliderBanners,
                    context: context,
                  ),
                ],
              )
                  : homeScreenProvider.homeScreenState == HomeScreenState.loading ||
